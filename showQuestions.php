    ...
    <body>
        <div class='container'>
            ...
            <div class="row">
                <div class="col-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Show Questions</li>
                    </ul>
                </div>
                <?php
            $errorMsg = ""; 
            ...
            if(!empty($_POST['questionDet']))
            {
                ...
                $addCourse = "INSERT INTO questions(question, section, courseTitle) VALUES ('$question', '$difficulty', '$courseName')";
            ...
            ?>
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="form-group">
                        ...
                        <input type="submit" value="Show" class="btn btn-primary"><br/><br/>
                    </div>
                    </div>
                </div>
            </div>
                ...
                {
                $sub= trim($_POST["courseSelect"]);
                $fetchlist=mysqli_query($conn, "select * from questions where courseTitle='$sub'");
                $i=0;
                echo "<table border='1'> 
                    <tr>
                    <th>ID</th>
